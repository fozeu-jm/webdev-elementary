...
<div class="card height-auto">
    <div class="card-body">
        ...
        {!! Form::open(['route' => 'students.filter', 'class' => 'mg-b-20', 'method' => 'POST']) !!}
                    ...
                    <div class="student-inner-std res-mg-b-30">
                        ...
                        <div class="student-dtl">
                            ...
                            <div style="text-align: center" class="info">
                                ...
                                <p class="dp"><b>Annee académique:</b> {!! $student->academicYear->begin !!} / {!! $student->academicYear->end !!}</p>
                            </div>
                            <div class="action">
                                <a class="action-link" href="{!! URL::route('students.fill', [$student->id]) !!}"><i class="flaticon-edit"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
