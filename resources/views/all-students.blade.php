...
<title >Elementary | Tous les etudiants</title>
...
<div class="card height-auto">
    <div class="card-body">
        ...
        {!! Form::open(['route' => 'students.search', 'class' => 'mg-b-20', 'method' => 'POST']) !!}
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="student-inner-std res-mg-b-30">
                        ...
                        <div class="student-dtl">
                            ...
                            <div class="action">
                                <a class="action-link" href="{!! URL::route('students.show', [$student->id]) !!}"><i class="flaticon-cv"></i></a>
                                <a class="action-link" href="{!! URL::route('students.edit', [$student->id]) !!}"><i class="flaticon-edit"></i></a>
                                {!! Form::open(['route' => ['students.destroy',$student->id],'method' => 'DELETE', 'class' => 'deleter new-added-form']) !!}
                                <button style="border: none; background: none; color: #007bff;cursor: pointer;" onclick="return confirm('Vraiment supprimer cette étudiant ?')" type="submit" class="action-link">
